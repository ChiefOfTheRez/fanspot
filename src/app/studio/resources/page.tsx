  ...
  return (
    <Shell active="/studio">
      <div className="space-y-5 pb-24">
        <div>
          <h1 className="text-3xl font-black tracking-tight text-white">Creator resources</h1>
          <p className="mt-2 text-sm text-slate-400">Organize downloadable resources, pinned links, templates, and supporter files.</p>
        </div>
        <StudioNav active="/studio/resources" />
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          <MetricCard label="Resource files" value="12" change="Library" />
<MetricCard label="Pinned links" value="5" change="Profile" />
<MetricCard label="Download events" value="184" change="30 days" />
<MetricCard label="Storage used" value="1.8 GB" change="S3 planned" />
        </div>
        <WorkflowColumn
