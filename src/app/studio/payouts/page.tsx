  ...
  return (
    <Shell active="/studio">
      <div className="space-y-5 pb-24">
        <div>
          <h1 className="text-3xl font-black tracking-tight text-white">Creator payouts</h1>
          <p className="mt-2 text-sm text-slate-400">Review available balance, holds, payout batches, and payout readiness.</p>
        </div>
        <StudioNav active="/studio/payouts" />
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          <MetricCard label="Available" value="$6,720" change="Ready" />
<MetricCard label="On hold" value="$1,180" change="7-day hold" />
<MetricCard label="Next payout" value="Friday" change="Weekly" />
<MetricCard label="Dispute reserve" value="$420" change="Review" />
        </div>
        <WorkflowColumn
