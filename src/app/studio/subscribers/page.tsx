  ...
  return (
    <Shell active="/studio">
      <div className="space-y-5 pb-24">
        <div>
          <h1 className="text-3xl font-black tracking-tight text-white">Subscribers</h1>
          <p className="mt-2 text-sm text-slate-400">Understand current supporters, retention signals, renewal risk, and tier distribution.</p>
        </div>
        <StudioNav active="/studio/subscribers" />
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          <MetricCard label="Active supporters" value="428" change="+22" />
<MetricCard label="At-risk supporters" value="19" change="Needs attention" />
<MetricCard label="Top tier" value="Silver" change="54%" />
<MetricCard label="Avg lifetime" value="4.2 mo" change="Growing" />
        </div>
        <WorkflowColumn
