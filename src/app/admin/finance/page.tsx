  ...
  return (
    <Shell active="/admin">
      <div className="space-y-5 pb-24">
        <div>
          <h1 className="text-3xl font-black tracking-tight text-white">Finance ops</h1>
          <p className="mt-2 text-sm text-slate-400">Monitor revenue, fees, reserves, creator balances, and payout batches.</p>
        </div>
        <AdminNav active="/admin/finance" />
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          <MetricCard label="Gross volume" value="$18.2k" change="Month" />
<MetricCard label="Creator net" value="$14.8k" change="Projected" />
<MetricCard label="Platform fee" value="$3.4k" change="Before costs" />
<MetricCard label="Reserve" value="$1.2k" change="Held" />
        </div>
